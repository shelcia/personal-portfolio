    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 top-1/2  flex justify-start items-start  rounded-2xl shadow-sm group-hover/pin:border-white/20 transition duration-700 overflow-hidden"
        >
